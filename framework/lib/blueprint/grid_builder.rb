...
module SimplyCivi
  ...
  class GridBuilder
    ...
    def initialize(options={})
      ...
      @column_width = options[:column_width] || SimplyCivi::COLUMN_WIDTH
      @gutter_width = options[:gutter_width] || SimplyCivi::GUTTER_WIDTH
      @output_path  = options[:output_path]  || SimplyCivi::SOURCE_PATH
    end
