#!/usr/bin/env ruby
require File.join(File.dirname(__FILE__), "SimplyCivi", "SimplyCivi")

# **Basic
#
#   Calling this file by itself will pull files from SimplyCivi/src and
...
#
#     This would compress and export SimplyCivis CSS to the respective directory,
...
#     standard with SimplyCivi for quite some time.  However, you can specify a
...
#     To use the SimplyCivi default, do not define this in your settings file.
#
#     Semantic classes are still in the works within SimplyCivi, but a simple
...
#
#     Also supported is plugins.  The compressor looks withinSimplyCivi_DIR/SimplyCivi/plugins
...
SimplyCivi::Compressor.new.generate!
